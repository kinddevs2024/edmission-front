...
const LOCALE_PATCHES: Record<string, Record<string, Record<string, string>>> = {
  ru: {
    ...
    student: {
      stepPrivacy: 'Приватность профиля',
      profileVisibilityTitle: 'Видимость для университетов',
      profileVisibilityPrivate: 'Приватный',
      profileVisibilityPublic: 'Публичный',
      profileVisibilityHint: 'По умолчанию приватный: университеты видят учёбу, навыки, интересы и цели - без имени, фото, почты и контактов. Другие студенты всегда видят полный профиль.',
      profileVisibilityPrivateLong: 'Университетам видна только учебная информация. Имя, фото и контакты от них скрыты.',
      profileVisibilityPublicLong: 'Университеты видят полный профиль, включая имя, фото и контакты.',
  ...
  uz: {
    ...
    student: {
      stepPrivacy: 'Profil maxfiyligi',
      profileVisibilityTitle: 'Universitetlar uchun ko‘rinish',
      profileVisibilityPrivate: 'Yopiq',
      profileVisibilityPublic: 'Ochiq',
      profileVisibilityHint: 'Standart holat yopiq: universitetlar o‘qish, ko‘nikmalar, qiziqishlar va maqsadlarni ko‘radi - ism, foto, email va kontaktlarsiz. Boshqa talabalar to‘liq profilingizni ko‘radi.',
      profileVisibilityPrivateLong: 'Universitetlar faqat o‘qishga oid ma’lumotni ko‘radi. Ism, foto va kontaktlar yashirin bo‘ladi.',
      profileVisibilityPublicLong: 'Universitetlar ism, foto va kontaktlar bilan to‘liq profilingizni ko‘radi.',
