...
const LOCALE_PATCHES: Record<string, Record<string, Record<string, string>>> = {
  ru: {
    ...
    student: {
      ...
      profileVisibilityHint: 'По умолчанию профиль публичный. В приватном режиме университеты всё равно видят имя и учебные данные, но фото, почта и контакты скрыты.',
      profileVisibilityPrivateLong: 'Университетам видны имя и учебная информация. Фото, почта и контакты скрыты.',
  ...
  uz: {
    ...
    student: {
      ...
      profileVisibilityHint: 'Standart holat ochiq. Yopiq rejimda universitetlar ism va ta’lim ma’lumotlarini ko‘radi, foto, email va kontaktlar yashiriladi.',
      profileVisibilityPrivateLong: 'Universitetlar ism va o‘qishga oid ma’lumotlarni ko‘radi. Foto va kontaktlar yashirin bo‘ladi.',
