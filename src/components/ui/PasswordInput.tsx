...
export const PasswordInput = forwardRef<HTMLInputElement, PasswordInputProps>(
  function PasswordInput(
    ...
    const manuallyVisible =
      typeof passwordVisible === "boolean" ? passwordVisible : internalVisible;
    ...
    const syncScroll = (target: HTMLInputElement | null) => {
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              error &&
                "border-red-500 focus:ring-red-500 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1),0_2px_0_0_rgba(239,68,68,0.2)]",
              !error &&
                "border-[var(--color-border)] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_2px_0_0_rgba(0,0,0,0.05),0_3px_5px_0_rgba(0,0,0,0.03)]",
              className,
            )}
            style={{
          ...
          {showPasswordToggle ? (
            <div className="pointer-events-auto absolute right-2 top-1/2 z-20 flex h-8 w-8 -translate-y-1/2 items-center justify-center">
              <button
                ...
                aria-label={
                  manuallyVisible ? t("hidePassword") : t("showPassword")
                }
              >
                {manuallyVisible ? (
