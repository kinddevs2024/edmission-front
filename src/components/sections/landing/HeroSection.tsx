              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-lg font-semibold">{t('hero.preview.sampleUniversity', 'Global Engineering Institute')}</p>
                    <p className="text-sm text-[var(--color-text-muted)]">{t('hero.preview.sampleLocation', 'Berlin, Germany')}</p>
                  </div>
