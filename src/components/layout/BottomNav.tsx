    ...
    <>
      ...
      >
        <div
          ...
          style={{
            WebkitMaskImage:
              "linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.72) 35%, rgba(0,0,0,0.2) 72%, transparent 100%)",
            maskImage:
              "linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.72) 35%, rgba(0,0,0,0.2) 72%, transparent 100%)",
          }}
        />
        ...
        {items.map(({ to, label, icon, section: _s }) => {
          const forceInactive =
            (to === "/student/universities" &&
              location.pathname.startsWith("/student/universities/map")) ||
            (to === "/university/students" &&
              location.pathname.startsWith("/university/students/map")) ||
            (to === "/school/my-students" &&
              location.pathname.startsWith("/school/my-students/map"));
